...
const products: Product[] = [
  ...
  },
  {
    ...
    moonPhase: 'Full Moon',
    description: 'Clear quartz point, moonstone cabochon, hand-harvested white sage bundle, and a full moon ritual instruction card — everything you need to harness the peak lunar energy.',
  },
];
